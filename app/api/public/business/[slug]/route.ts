...
export async function GET(_:Request,{params}:{params:Promise<{slug:string}>}){
 try{
  ...
  const [cats,services,pros,schedules,links,blocks,appointments]=await Promise.all([
  ...
  return NextResponse.json({business,categories:cats.data||[],services:services.data||[],professionals:pros.data||[],schedules:schedules.data||[],professionalCategories:links.data||[],blocks:blocks.data||[],appointments:appointments.data||[]});
